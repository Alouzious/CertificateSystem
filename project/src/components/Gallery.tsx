  ...
  const templates: Array<{ template: CertificateTemplate; description: string; features: string[] }> = [
    {
      template: {
        ...
        signature3: { name: 'Ms. Lisa Taylor', title: 'Registrar' },
    ...
    },
    {
      template: {
        ...
        signature3: { name: 'Casey Morgan', title: 'Creative Lead' },
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
      },
    ...
    },
    {
      template: {
        ...
        signature3: { name: 'Mark Johnson', title: 'HR Director' },
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
      },
    ...
    },
    {
      template: {
        ...
        signature3: { name: 'Dr. Richard Martinez', title: 'Provost' },
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
      },
    ...
    },
    {
      template: {
        ...
        signature3: { name: 'Jamie Dev', title: 'Tech Director' },
        createdAt: new Date().toISOString(),
        updatedAt: new Date().toISOString(),
      },
